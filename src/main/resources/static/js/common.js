...
const i18n = new VueI18n({
    locale: 'zh-CN', // 设置语言环境
    fallbackLocale: 'zh-CN', // 预设的语言环境【当前语言环境没有要获取的值时，默认从这个语言环境查找（预设的语言环境·首选语言缺少翻译时要使用的语言）】
    messages: {"zh-CN":{}},  // 设置各本地化的语言环境信息
...
const mixins = [{
    ...
    data: function() {
        return {
            ...
            locales: [{lang: "zh-CN", text: "简体中文"},{lang: "en-US", text: "English"},{lang: "ja-JP", text: "日本語"}],
            lang: "zh-CN",
            showToast: false,
            toastText: ''
        }
